...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        print (f"Then you remember the code was {code}")
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if guess in good_pods:
            print (f"Soon after getting into pod {guess}, it launches smoothly into")
            ...
            print (f"Soon after getting into pod {guess}, it launches into the void") 
            ...
            print (f"Excape pod {guess} is not available.")
            return 'escape_pod'
